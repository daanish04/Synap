...
const Hero = () => {
  ...
  return (
    <section className="relative py-20 flex flex-col items-center justify-start text-center bg-gradient-to-r from-slate-50 via-blue-100 to-violet-100 border-b-2 border-slate-200/60 overflow-hidden">
      ...
      <div className="container overflow-hidden px-4 flex flex-col md:flex-row items-center gap-4">
